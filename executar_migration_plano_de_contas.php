<?php
/**
 * Script para executar migration de plano de contas
 */
...
try {
    echo "=== Executando Migration 044 - Plano de Contas ===\n\n";

    $db = BancoDados::obterInstancia();
    $sqlFile = __DIR__ . '/database/migrations/044_criar_tabela_plano_de_contas.sql';
            ...
            try {
                ...
                if (
                    ...
                    ErrorLogger::log($e, [
                        ...
                        'nivel' => 'medio',
                        'contexto' => [
                            'script' => 'migration_plano_de_contas',
                            'descricao' => 'Erro ao executar statement da migration 044'
                        ]
                    ]);
    ...
    ErrorLogger::log($e, [
        ...
        'contexto' => [
            'script' => 'migration_plano_de_contas',
            'descricao' => 'Erro fatal ao executar migration 044 - plano de contas'
        ]
    ]);
