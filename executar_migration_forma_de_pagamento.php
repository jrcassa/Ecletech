<?php
/**
 * Script para executar migration de forma de pagamento
 */
...
try {
    echo "=== Executando Migration 046 - Forma de Pagamento ===\n\n";

    $db = BancoDados::obterInstancia();
    $sqlFile = __DIR__ . '/database/migrations/046_criar_tabela_forma_de_pagamento.sql';
            ...
            try {
                ...
                if (
                    ...
                    ErrorLogger::log($e, [
                        ...
                        'nivel' => 'medio',
                        'contexto' => [
                            'script' => 'migration_forma_de_pagamento',
                            'descricao' => 'Erro ao executar statement da migration 046'
                        ]
                    ]);
    ...
    ErrorLogger::log($e, [
        ...
        'contexto' => [
            'script' => 'migration_forma_de_pagamento',
            'descricao' => 'Erro fatal ao executar migration 046 - forma de pagamento'
        ]
    ]);
